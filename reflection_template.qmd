...
#EDIT: second inner_join used for linking people & interviews
...
# Lab 2: scatterplot of weight vs hindfoot length
...
# Lab 10 – proportion of correct baby matches.
...
# Lab 7: counting missing values for every column at once.
...
# Lab 10 – using map_int() to repeat a simulation 10,000 times
...
# Challenge 7 – function operating on a numeric vector
...
# Lab 7 – rescale_01(), a vector function that can be used directly or inside mutate() on data frame columns
...
# copied from Lab 10: vectors estimate and conf.low used together
